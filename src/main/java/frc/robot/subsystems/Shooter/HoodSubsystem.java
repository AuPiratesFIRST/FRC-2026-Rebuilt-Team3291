 ...
 * allow setAngle() calls to work without errors, but they are effectively
 * no-ops.
 * 
...
public class HoodSubsystem extends SubsystemBase {
     ...
     * private final SparkMax hoodMotor = new SparkMax(29,
    ...
    private static final Angle FIXED_ANGLE = Degrees.of(64.0925956);
