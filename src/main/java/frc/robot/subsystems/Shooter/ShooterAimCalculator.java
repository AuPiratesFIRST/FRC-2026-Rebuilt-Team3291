...
public final class ShooterAimCalculator {
        ...
        public record MovingShotSolution(Rotation2d chassisHeading, double rpm, Angle hoodAngle,
        ...
        public static ShooterSolution solve(double distanceMeters) {
                ...
                return new ShooterSolution(Degrees.of(hoodAngleMap.get(clamped)), rpmMap.get(clamped), 0.0, clamped,
                                true);
        }
